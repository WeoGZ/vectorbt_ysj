FUTURE_LIST_PRECIOUS_METALS: list[str] = [
    "AUL9",  # 沪金
    "AGL9",  # 沪银
]
"""贵金属板块"""
...
FUTURE_LIST_ALL: list[str] = (FUTURE_LIST_PRECIOUS_METALS + FUTURE_LIST_NONFERROUS_METALS + FUTURE_LIST_FERROUS_METALS +
                              FUTURE_LIST_COAL + FUTURE_LIST_LIGHT_INDUSTRY + FUTURE_LIST_PETROLEUM +
                              FUTURE_LIST_CHEMICAL_INDUSTRY + FUTURE_LIST_GREASE + FUTURE_LIST_GRAIN +
                              FUTURE_LIST_SOFT_COMMODITY + FUTURE_LIST_AGRICULTURAL_SIDELINE_PRODUCTS +
